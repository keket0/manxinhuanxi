# Daily memory and journal heartbeat

## On heartbeat, do useful work instead of only checking state

Priority order:
1. If there is active user work, advance it first.
...
- Before ending the day, make sure the daily note contains:
  - 今日完成
  - 关键决定
  - 遇到的失败/阻塞
  - 下一步
- If there was meaningful project progress, keep a short human-readable summary.
...
- If a missing capability keeps recurring, look for free skills first:
  1. ClawHub official registry
  2. GitHub high-star free sources
- Prefer fewer better skills over bulk installs.
